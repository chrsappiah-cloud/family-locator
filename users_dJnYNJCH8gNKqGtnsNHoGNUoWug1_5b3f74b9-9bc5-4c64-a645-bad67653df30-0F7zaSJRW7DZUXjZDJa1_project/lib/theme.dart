...
class AppGradients {
  static const LinearGradient diamondGradient = LinearGradient(
    colors: [Color(0xFF6B8DB5), Color(0xFF3F6382)],
    begin: Alignment.topLeft,
    end: Alignment.bottomRight,
  );

  static const LinearGradient emeraldGradient = LinearGradient(
    colors: [Color(0xFF5BA786), Color(0xFF236546)],
    begin: Alignment.topLeft,
    end: Alignment.bottomRight,
  );

  static const LinearGradient goldenIceGradient = LinearGradient(
    colors: [Color(0xFFE8CA8C), Color(0xFFA5C3D1)],
    begin: Alignment.topLeft,
    end: Alignment.bottomRight,
  );
}
